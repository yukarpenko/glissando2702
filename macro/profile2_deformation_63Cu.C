/** \file profile2_deformation_63Cu.C
...
void profile2_deformation_63Cu(
...
r_costheta_hist->SetTitle("r-cos(#theta) profile, nucleus 63Cu (deformed, #beta2 = 0.16 , #beta4 = 0.0)");
...
r_costheta_hist_sym->SetTitle("r-cos(#theta) profile, nucleus 63Cu (spherical)");
...
c1->Modified();
c1->Update();
c1->SaveAs("rcostheta_spherical_deformed_63Cu.eps");
